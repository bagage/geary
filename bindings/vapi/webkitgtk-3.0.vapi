...
namespace WebKit {
	namespace DOM {
		...
		public class AudioTrackList : WebKit.DOM.Object, WebKit.DOM.EventTarget {
			...
			public WebKit.DOM.AudioTrack get_track_by_id (string id);
			public WebKit.DOM.AudioTrack item (ulong index);
		...
		public class Blob : WebKit.DOM.Object {
			...
			public WebKit.DOM.Blob slice (int64 start, int64 end, string contentType);
		...
		public class DOMMimeType : WebKit.DOM.Object {
			...
			public WebKit.DOM.DOMPlugin get_enabled_plugin ();
			public string get_suffixes ();
			public string description { owned get; }
			public WebKit.DOM.DOMPlugin enabled_plugin { owned get; }
		...
		public class DOMMimeTypeArray : WebKit.DOM.Object {
			...
			public ulong get_length ();
			public WebKit.DOM.DOMMimeType item (ulong index);
			public WebKit.DOM.DOMMimeType named_item (string name);
			public ulong length { get; }
		}
		...
		public class DOMNamedFlowCollection : WebKit.DOM.Object {
			...
			public ulong get_length ();
			public WebKit.DOM.WebKitNamedFlow item (ulong index);
			public WebKit.DOM.WebKitNamedFlow named_item (string name);
			public ulong length { get; }
		}
		...
		public class DOMPluginArray : WebKit.DOM.Object {
			...
			public ulong get_length ();
			public WebKit.DOM.DOMPlugin item (ulong index);
			public WebKit.DOM.DOMPlugin named_item (string name);
		...
		public class DOMSecurityPolicy : WebKit.DOM.Object {
			...
			public WebKit.DOM.DOMStringList get_report_ur_is ();
			...
			public WebKit.DOM.DOMStringList report_ur_is { owned get; }
		}
		...
		public class DOMSelection : WebKit.DOM.Object {
			...
			public WebKit.DOM.Range get_range_at (long index) throws GLib.Error;
		...
		public class DOMWindow : WebKit.DOM.Object, WebKit.DOM.EventTarget {
			...
			public void focus ();
			public WebKit.DOM.DOMApplicationCache get_application_cache ();
			public WebKit.DOM.Navigator get_client_information ();
			...
			public WebKit.DOM.DOMWindowCSS get_css ();
			...
			public WebKit.DOM.History get_history ();
			public long get_inner_height ();
			public long get_inner_width ();
			public ulong get_length ();
			public WebKit.DOM.Storage get_local_storage () throws GLib.Error;
			public WebKit.DOM.BarProp get_locationbar ();
			public WebKit.DOM.BarProp get_menubar ();
			public string get_name ();
			public WebKit.DOM.Navigator get_navigator ();
			...
			public WebKit.DOM.Performance get_performance ();
			public WebKit.DOM.BarProp get_personalbar ();
			public WebKit.DOM.Screen get_screen ();
			...
			public WebKit.DOM.BarProp get_scrollbars ();
			public WebKit.DOM.DOMSelection get_selection ();
			public WebKit.DOM.DOMWindow get_self ();
			public WebKit.DOM.Storage get_session_storage () throws GLib.Error;
			public string get_status ();
			public WebKit.DOM.BarProp get_statusbar ();
			public WebKit.DOM.StyleMedia get_style_media ();
			public WebKit.DOM.BarProp get_toolbar ();
			...
			public WebKit.DOM.MediaQueryList match_media (string query);
			...
			public WebKit.DOM.WebKitPoint webkit_convert_point_from_node_to_page (WebKit.DOM.Node node, WebKit.DOM.WebKitPoint p);
			public WebKit.DOM.WebKitPoint webkit_convert_point_from_page_to_node (WebKit.DOM.Node node, WebKit.DOM.WebKitPoint p);
			public WebKit.DOM.DOMApplicationCache application_cache { owned get; }
			public WebKit.DOM.Navigator client_information { owned get; }
			public bool closed { get; }
			public WebKit.DOM.Console console { get; }
			public WebKit.DOM.DOMWindowCSS css { owned get; }
			...
			public WebKit.DOM.History history { owned get; }
			public long inner_height { get; }
			public long inner_width { get; }
			public ulong length { get; }
			public WebKit.DOM.Storage local_storage { owned get; }
			public WebKit.DOM.BarProp locationbar { owned get; }
			public WebKit.DOM.BarProp menubar { owned get; }
			public string name { owned get; set; }
			public WebKit.DOM.Navigator navigator { owned get; }
			...
			public WebKit.DOM.Performance performance { owned get; }
			public WebKit.DOM.BarProp personalbar { owned get; }
			public WebKit.DOM.Screen screen { owned get; }
			...
			public WebKit.DOM.BarProp scrollbars { owned get; }
			public WebKit.DOM.DOMWindow self { owned get; }
			public WebKit.DOM.Storage session_storage { owned get; }
			public string status { owned get; set; }
			public WebKit.DOM.BarProp statusbar { owned get; }
			public WebKit.DOM.StyleMedia style_media { owned get; }
			public WebKit.DOM.BarProp toolbar { owned get; }
		...
		public class Document : WebKit.DOM.Node, WebKit.DOM.EventTarget {
			...
			public WebKit.DOM.Touch create_touch (WebKit.DOM.DOMWindow window, WebKit.DOM.EventTarget target, long identifier, long pageX, long pageY, long screenX, long screenY, long webkitRadiusX, long webkitRadiusY, float webkitRotationAngle, float webkitForce) throws GLib.Error;
			...
			public WebKit.DOM.DOMSecurityPolicy get_security_policy ();
			...
			public WebKit.DOM.DOMNamedFlowCollection webkit_get_named_flows ();
			...
			public WebKit.DOM.DOMSecurityPolicy security_policy { owned get; }
		...
		[CCode (cheader_filename = "webkit/webkit.h", has_type_id = false)]
		[Compact]
		...
		public class GamepadList : WebKit.DOM.Object {
			...
			public ulong get_length ();
			public WebKit.DOM.Gamepad item (ulong index);
			public ulong length { get; }
		}
		...
		public class HTMLButtonElement : WebKit.DOM.HTMLElement, WebKit.DOM.EventTarget {
			...
			public WebKit.DOM.NodeList get_labels ();
			public string get_name ();
			public string get_validation_message ();
			public WebKit.DOM.ValidityState get_validity ();
			public string get_value ();
			...
			public WebKit.DOM.ValidityState validity { owned get; }
			public string value { owned get; set; }
		...
		[CCode (cheader_filename = "webkit/webkit.h", lower_case_cprefix = "webkit_dom_html_iframe_element_", type_id = "webkit_dom_html_iframe_element_get_type ()")]
		...
		public class HTMLMediaElement : WebKit.DOM.HTMLElement, WebKit.DOM.EventTarget {
			...
			public WebKit.DOM.TextTrack add_text_track (string kind, string label, string language) throws GLib.Error;
			public string can_play_type (string type);
			public void fast_seek (double time);
			public WebKit.DOM.AudioTrackList get_audio_tracks ();
			public bool get_autoplay ();
			public WebKit.DOM.TimeRanges get_buffered ();
			public WebKit.DOM.MediaController get_controller ();
			...
			public WebKit.DOM.MediaError get_error ();
			[Version (deprecated = true, deprecated_since = "2.2")]
			...
			public WebKit.DOM.TimeRanges get_played ();
			public string get_preload ();
			public ushort get_ready_state ();
			public WebKit.DOM.TimeRanges get_seekable ();
			public bool get_seeking ();
			public string get_src ();
			[Version (deprecated = true, deprecated_since = "2.2")]
			public double get_start_time ();
			public unowned WebKit.DOM.TextTrackList get_text_tracks ();
			public unowned WebKit.DOM.VideoTrackList get_video_tracks ();
			...
			public WebKit.DOM.AudioTrackList audio_tracks { owned get; }
			public bool autoplay { get; set; }
			public WebKit.DOM.TimeRanges buffered { owned get; }
			public WebKit.DOM.MediaController controller { owned get; }
			...
			public WebKit.DOM.MediaError error { owned get; }
			...
			public WebKit.DOM.TimeRanges played { owned get; }
			public string preload { owned get; set; }
			public uint ready_state { get; }
			public WebKit.DOM.TimeRanges seekable { owned get; }
			public bool seeking { get; }
			public string src { owned get; set; }
			public WebKit.DOM.TextTrackList text_tracks { get; }
			public WebKit.DOM.VideoTrackList video_tracks { get; }
		...
		public class HTMLSelectElement : WebKit.DOM.HTMLElement, WebKit.DOM.EventTarget {
			...
			public bool get_required ();
			public long get_selected_index ();
			public WebKit.DOM.HTMLCollection get_selected_options ();
			public long get_size ();
			public string get_validation_message ();
			public WebKit.DOM.ValidityState get_validity ();
			public string get_value ();
		...
		public class Location : WebKit.DOM.Object {
			[CCode (has_construct_function = false)]
			protected Location ();
			public WebKit.DOM.DOMStringList get_ancestor_origins ();
			public string get_hash ();
			public string get_host ();
			public string get_hostname ();
			public string get_href ();
			...
			public string get_protocol ();
			public string get_search ();
			public WebKit.DOM.DOMStringList ancestor_origins { owned get; }
			public string hash { owned get; }
			public string host { owned get; }
			public string hostname { owned get; }
		...
		[CCode (cheader_filename = "webkit/webkit.h", type_id = "webkit_dom_media_controller_get_type ()")]
		...
		public class Navigator : WebKit.DOM.Object {
			...
			public WebKit.DOM.Geolocation get_geolocation ();
			public string get_language ();
			public WebKit.DOM.DOMMimeTypeArray get_mime_types ();
			public bool get_on_line ();
			public string get_platform ();
			public WebKit.DOM.DOMPluginArray get_plugins ();
			...
			public WebKit.DOM.BatteryManager get_webkit_battery ();
			...
			public WebKit.DOM.GamepadList webkit_get_gamepads ();
			...
			public WebKit.DOM.Geolocation geolocation { owned get; }
			public string language { owned get; }
			public WebKit.DOM.DOMMimeTypeArray mime_types { owned get; }
			public bool on_line { get; }
			public string platform { owned get; }
			public WebKit.DOM.DOMPluginArray plugins { owned get; }
			...
			public WebKit.DOM.BatteryManager webkit_battery { owned get; }
		...
		public class Performance : WebKit.DOM.Object, WebKit.DOM.EventTarget {
			...
			[Version (deprecated = true, deprecated_since = "2.2")]
			public void* get_memory ();
			public WebKit.DOM.PerformanceNavigation get_navigation ();
			public WebKit.DOM.PerformanceTiming get_timing ();
			public double now ();
			public WebKit.DOM.PerformanceNavigation navigation { owned get; }
			public WebKit.DOM.PerformanceTiming timing { owned get; }
		}
		...
		public class PerformanceEntryList : WebKit.DOM.Object {
			...
			public ulong get_length ();
			public WebKit.DOM.PerformanceEntry item (ulong index);
			public ulong length { get; }
		}
		...
		public class ShadowRoot : WebKit.DOM.DocumentFragment, WebKit.DOM.EventTarget {
			...
			public unowned WebKit.DOM.Element get_element_by_id (string elementId);
			public WebKit.DOM.NodeList get_elements_by_class_name (string className);
			public WebKit.DOM.NodeList get_elements_by_tag_name (string tagName);
			public WebKit.DOM.NodeList get_elements_by_tag_name_ns (string namespaceURI, string localName);
			public string get_inner_html ();
		...
		public class TextTrack : WebKit.DOM.Object, WebKit.DOM.EventTarget {
			...
			public WebKit.DOM.TextTrackCueList get_active_cues ();
			public WebKit.DOM.TextTrackCueList get_cues ();
			public string get_id ();
			public string get_kind ();
			public string get_label ();
			public string get_language ();
			...
			public WebKit.DOM.TextTrackCueList active_cues { owned get; }
			public WebKit.DOM.TextTrackCueList cues { owned get; }
			public string id { owned get; }
			public string kind { owned get; }
			public string label { owned get; }
			public string language { owned get; }
		...
		public class TextTrackCue : WebKit.DOM.Object, WebKit.DOM.EventTarget {
			...
			public double get_start_time ();
			public string get_text ();
			public WebKit.DOM.TextTrack get_track ();
			...
			public string text { owned get; set; }
			public WebKit.DOM.TextTrack track { owned get; }
		...
		public class TextTrackList : WebKit.DOM.Object, WebKit.DOM.EventTarget {
			...
			public ulong get_length ();
			public WebKit.DOM.TextTrack get_track_by_id (string id);
			public WebKit.DOM.TextTrack item (ulong index);
			public ulong length { get; }
		}
		...
		[CCode (cheader_filename = "webkit/webkit.h", type_id = "webkit_dom_touch_get_type ()")]
		[GIR (name = "DOMTouch")]
		...
		[CCode (cheader_filename = "webkit/webkit.h", type_id = "webkit_dom_video_playback_quality_get_type ()")]
		...
		public class VideoTrackList : WebKit.DOM.Object, WebKit.DOM.EventTarget {
			...
			public ulong get_length ();
			public WebKit.DOM.VideoTrack get_track_by_id (string id);
			public WebKit.DOM.VideoTrack item (ulong index);
			public ulong length { get; }
		}
		[CCode (cheader_filename = "webkit/webkit.h", lower_case_cprefix = "webkit_dom_webkit_named_flow_", type_id = "webkit_dom_webkit_named_flow_get_type ()")]
		...
		public class WebKitNamedFlow : WebKit.DOM.Object, WebKit.DOM.EventTarget {
			...
			public WebKit.DOM.NodeList get_content ();
			[Version (deprecated = true, deprecated_since = "1.10")]
			...
			public WebKit.DOM.NodeList get_regions ();
			public WebKit.DOM.NodeList get_regions_by_content (WebKit.DOM.Node contentNode);
			[Version (deprecated = true, deprecated_since = "1.10")]
		...
		[CCode (cheader_filename = "webkit/webkit.h", lower_case_cprefix = "webkit_dom_webkit_point_", type_id = "webkit_dom_webkit_point_get_type ()")]
		...
		[CCode (cheader_filename = "webkit/webkit.h", type_id = "webkit_dom_wheel_event_get_type ()")]
	...
	public class IconDatabase : GLib.Object {
		...
		[Version (deprecated = true, deprecated_since = "1.8", since = "1.3.13")]
		public void clear ();
		[Version (deprecated = true, deprecated_since = "1.8", since = "1.3.13")]
	...
	public class WebFrame : GLib.Object {
		[CCode (has_construct_function = false)]
		[Version (deprecated = true, deprecated_since = "1.0.2")]
		...
		[Version (deprecated = true, deprecated_since = "1.1.18")]
	...
	public class WebSettings : GLib.Object {
		...
		[Version (since = "1.1.11")]
		public unowned string get_user_agent ();
		[NoAccessorMethod]
		public bool auto_load_images { get; set construct; }
		[NoAccessorMethod]
		[Version (since = "1.1.22")]
	...
	public class WebView : Gtk.Container, Atk.Implementor, Gtk.Buildable, Gtk.Scrollable {
		...
		[Version (deprecated = true, deprecated_since = "1.1.1")]
		...
		[Version (deprecated = true, deprecated_since = "1.1.4")]
	...
	[CCode (cheader_filename = "webkit/webkit.h", has_type_id = false)]
	[Version (since = "1.3.8")]
	public struct WebPluginMIMEType {
